...
# 6. Principal Dashboard (Sidebar Password Protected)
st.sidebar.markdown("---")
st.sidebar.header("👑 Principal Access")
password = st.sidebar.text_input("Enter Principal Password", type="password")

if password == "12345":  # പാസ്‌വേഡ് ഇവിടെ മാറ്റാം
    st.markdown("---")
    ...
    st.sidebar.warning("Enter correct password to view Dashboard.")
